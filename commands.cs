...
namespace ConsoleApp
{
    class commands
    {
        ...
        public void Help()
        {
            ...
            Console.WriteLine("command :| /view.fullprofiledata[all] | to shows all full profiles infromration");
            Console.WriteLine("command :| /view.fullprofiledata[index of profile wich data you want to view( example: /view.fullprofiledata[1] )] | to show individual profile information");
